                ...
                <header class="entry-header">
                    ...
                    <div class="entry-meta">
                        ...
                        <span class="author vcard">
                            <a class="url fn n" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" title="<?php echo esc_attr( __( 'All post by ', 'odin' ) . get_the_author() ); ?>" rel="author"><?php echo get_the_author(); ?></a>
                        </span>
