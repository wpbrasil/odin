...
jQuery(document).ready(function($) {
    ...
    // Socialite Scroll
    var shareButtons = $('.social-buttons'), socialised = { }, win = $(window), updateButtons, onUpdate, updateTimeout;
    updateButtons = function() {
        ...
        var wT = win.scrollTop(),
            ...
            wR = wL + win.width(),
            wB = wT + win.height();
        // check which shareButtons are visible and socialise!
        for (var i = 0; i < shareButtons.length; i++) {
            if (socialised[i]) {
                continue;
            }
            // article bounds
            var art = $(shareButtons[i]),
                aT = art.offset().top,
                aL = art.offset().left,
                aR = aL + art.width(),
                aB = aT + art.height();
