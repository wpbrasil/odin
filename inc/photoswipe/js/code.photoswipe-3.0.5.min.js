...
// PhotoSwipe Plugin
(function(window, PhotoSwipe){ document.addEventListener('DOMContentLoaded', function(){
	var
		options = {
			/*allowUserZoom: true,
		...
		instance = PhotoSwipe.attach( window.document.querySelectorAll((".entry-content a[href$='.jpg'], .entry-content a[href$='.png'], .entry-content a[href$='.gif']")), options );
